...
{#if !syncLocale}
  <div class="dsm-toggle-row">
    ...
    <select class="dsm-select" bind:value={locale} style="width: 140px;">
...
<div class="dsm-settings-footer">
  <a class="dsm-github-link" href="https://github.com/mwahidops/deepseek-memory" target="_blank" rel="noopener noreferrer">
